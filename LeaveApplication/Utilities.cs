...
namespace LeaveApplication
{
    internal class Utilities
    {
        ...
        public static void SendNotification(SPWeb Web, string To, string Subject, string IssueNo, string Assigned)
        {
            ...
            if (Assigned == "Yes")
            {
                sb.Append(@"<tr><td style='font-family:Calibri'>Please "); sb.Append("<a href="); sb.Append(Web.Url.ToString() + "/Pages/DeveloperView.aspx"); sb.Append(">Click here</a>"); sb.Append(@" to view Form.</td><td></td></tr>");
            }
            else
            { sb.Append(@"<tr><td style='font-family:Calibri'>Please "); sb.Append("<a href="); sb.Append(Web.Url.ToString() + "/Pages/IssueAdminView.aspx"); sb.Append(">Click here</a>"); sb.Append(@" to view Form.</td><td></td></tr>"); }
