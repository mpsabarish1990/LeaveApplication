...
namespace LeaveApplication.NewWebparts.New_EmployeeInformation
{
    [ToolboxItemAttribute(false)]
    public partial class New_EmployeeInformation : WebPart
    {
        ...
        public New_EmployeeInformation()
        {
        }
                ...
                using (var site = new SPSite(SPContext.Current.Site.Url))
                {
                    using (var web = site.OpenWeb())
                    {
                        ...
                        foreach (SPListItem spListItem in itemCollection)
                        {
                            ...
                            string url = "'" + site.Url + "/Pages/EditEmployeeInformation.aspx?Empid=" +
                                         spListItem.ID + "'";
